...
public class IPPTCalculator extends AppCompatActivity{
    Spinner age, name, classes, gender;
    Button submit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ippt);

        overridePendingTransition(R.anim.fadein, R.anim.fadeout);

        //age = findViewById(R.id.spinnerAge);
        gender = findViewById(R.id.spinner_gender);
        classes = findViewById(R.id.spinner_IPPTClass);
        name = findViewById(R.id.spinnerName);
        submit = findViewById(R.id.btn_ipptsave);
        situps = findViewById(R.id.editText_Situps);
        pushups = findViewById(R.id.editText_Pushups);
        mins = findViewById(R.id.editText_Min);
        secs = findViewById(R.id.editText_Sec);
        points = findViewById(R.id.textView_points);
        award = findViewById(R.id.textView_award);
        ...
        ArrayAdapter<CharSequence> genderAdaper = ArrayAdapter.createFromResource(this, R.array.gender, android.R.layout.simple_spinner_item);
        genderAdaper.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        gender.setAdapter(genderAdaper);

        final int ageGroupSelection= getIntent().getIntExtra("ageGroup", -1);
        ...
        final ArrayAdapter<String> areasAdapter = new ArrayAdapter<String>(IPPTCalculator.this, android.R.layout.simple_spinner_item, classlist);
        ...
        final ArrayAdapter<String> areasAdapter1 = new ArrayAdapter<String>(IPPTCalculator.this, android.R.layout.simple_spinner_item, nameList);
        areasAdapter1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        name.setAdapter(areasAdapter1);
    ...
    public void submitIPPT(View view) {
        try {
            FirebaseDatabase database = FirebaseDatabase.getInstance();
            final String getname = name.getSelectedItem().toString();
            ...
            databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    for (DataSnapshot ds : dataSnapshot.getChildren()) {
                        ...
                        int situp = Integer.parseInt(situps.getText().toString());
                        int pushup = Integer.parseInt(pushups.getText().toString());
                        String awards = award.getText().toString();
                        int point = Integer.parseInt(points.getText().toString());
                        String timing = mins.getText().toString() + ":" + secs.getText().toString();
                        IPPT ippt = new IPPT(name1, situp, pushup, timing, point, awards);

                        if (ds.child("name").getValue(String.class) == getname) {
                            ds.getRef().child("IPPT").setValue(ippt);
                        }
                    }
                    Toast.makeText(getApplicationContext(), "IPPT results submitted.", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(IPPTCalculator.this, "Please enter valid entreis", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    {
        Button total = findViewById(R.id.btnCalculate);
        ...
        total.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(IPPTCalculator.this, "Please enter valid entries", Toast.LENGTH_SHORT).show();
                }
